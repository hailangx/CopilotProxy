# Start CopilotProxy Server in Background (Windows)
...
Write-Host "  ANTHROPIC_API_KEY: sk-ant-proxy..." -ForegroundColor Cyan
...
if ($ExistingProcess) {
    ...
    Write-Host "  .\scripts\windows\stop-proxy.ps1" -ForegroundColor Cyan
